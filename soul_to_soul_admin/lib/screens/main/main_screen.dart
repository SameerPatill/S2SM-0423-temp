...
import 'package:soul_to_soul_admin/screens/employees_screen.dart';
import 'package:soul_to_soul_admin/screens/search_marital_profile.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    List<Widget> screens = [
      ...
      EmployeesScreen(setStateCallBack),
